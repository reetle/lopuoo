...
where meedia_liik like 'OP' GROUP BY meedia_eksemplar.meedia HAVING COUNT(*) >= 1 LIMIT $start_from, $record_per_page "; 
...
LEFT JOIN valjaandja ON meedia.valjaandja =valjaandja.id)
LEFT JOIN meedia_eksemplar ON meedia.id=meedia_eksemplar.meedia)
where meedia_liik like 'OP' GROUP BY meedia_eksemplar.meedia HAVING COUNT(*) >= 1 and $column like '%$search%' " ;}
