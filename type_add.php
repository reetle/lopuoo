...
<body> 
    ...
    <div class="form-group row">  
		<input type="submit" name="save" value="Lisa" class="btn btn-">
          </div>
    </fieldset>
	</form>
    <?php
...
{	 
	 ...
	 $sql = "INSERT INTO liik (nimi, markused) 
     VALUES('$nimi','$markused')";
...
<a href="type_data.php" class="btn btn-info" role="button">Tagasi</a>
</div>
</div></div>
</body>
</html>