...
$sql= "SELECT * FROM valjaandja LIMIT $start_from, $record_per_page "; 
...
?>
 ...
 <div class="col-lg-10" style="margin-bottom:33rem; "id="filter">
	<div class="search_menu">
		<button onclick="window.location.href='publisher_add.php';">Lisa uus</button>
...
$sql= "SELECT * FROM valjaandja where $column like '%$search%' " ;}
