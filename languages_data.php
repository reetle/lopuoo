...
$sql= "SELECT * FROM keel LIMIT $start_from, $record_per_page "; 
...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
    <table id="editable_table" class="table table-sm table-hover " style="margin-left:-250px;">
    <thead>
		<tr>	
...
$sql= "SELECT * FROM keel where $column like '%$search%' " ;}
