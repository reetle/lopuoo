...
$sql= "SELECT * FROM andmekandja where andmekandja_liik like 'AV'  LIMIT $start_from, $record_per_page "; 
...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
    ...
    <table id="editable_table" class="table table-sm table-hover "style="margin-left:-100px; ">
    <thead>
		<tr>	
...
$sql="SELECT * FROM andmekandja where andmekandja_liik like 'AV' and $column like '%$search%' " ;}
...
<?php
	...
	$page_query = "SELECT * FROM andmekandja where andmekandja_liik like 'AV' and ";
