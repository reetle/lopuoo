...
include_once("config.php");
 ...
 {  
      ...
      $query = "select meedia.id, meedia.pealkiri,andmekandja.nimi as a, meedia.klass, meedia.autor, meedia.aasta, liik.nimi as l, keel.nimi as k, valjaandja.nimi as v, meedia.kogus, meedia.riiul, meedia.marksona, meedia.markused
      from ((((meedia
      ...
      where meedia_liik like 'MK' GROUP BY meedia_eksemplar.meedia HAVING COUNT(*) >= 1"; 
