...
<br><br>
<!--andmete eksport-->
 <form method="post" action="av_export.php" id="form2">  
                </form>  
...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
 ...
 <!-- filtreerib pealkirja järgi kasvavalt või kahanevalt, &#8693; lisab nooled -->	
        ...
        <th onclick="sortTable(2)">Andmekandja &#8693;</th> 
...
$sql=  "Select meedia.id, meedia.pealkiri, andmekandja.nimi as a, meedia.autor, meedia.aasta, meedia.keel, liik.nimi as l, keel.nimi as k, valjaandja.nimi as v, count(inventari_nr) as c, meedia.riiul, meedia.marksona, meedia.markused from (((((meedia LEFT join liik ON meedia.liik = liik.id) LEFT JOIN andmekandja on meedia.andmekandja=andmekandja.id) LEFT JOIN keel ON meedia.keel = keel.id) LEFT JOIN meedia_eksemplar ON meedia.id = meedia_eksemplar.meedia) LEFT JOIN valjaandja ON meedia.valjaandja =valjaandja.id) where meedia_liik like 'AV' GROUP BY meedia_eksemplar.meedia HAVING COUNT(*) >= 1 and $column like '%$search%' " ;}
...
<?php
	...
	$page_query = "Select * from meedia where meedia_liik like 'AV' ";
